...
{	
	...
	public static void createBlocks()
	{
		...
		graniteRoads = new BlockMultiRoad(Material.rock, new String[]{MAssetManager.getEDStonecutterTexture("Granite_Road_Side_0"), MAssetManager.getEDStonecutterTexture("Granite_Road_Side_Bronze"), MAssetManager.getEDStonecutterTexture("Granite_Road_Side_Meurodite"), MAssetManager.getEDStonecutterTexture("Granite_Road_Side_Steel")}, new String[]{MAssetManager.getEDStonecutterTexture("Granite_Refined_0_0"), MAssetManager.getEDStonecutterTexture("Granite_Refined_0_Bronze"), MAssetManager.getEDStonecutterTexture("Granite_Refined_0_Meurodite"), MAssetManager.getEDStonecutterTexture("Granite_Refined_0_Steel")}, new String[]{"dirt" ,"dirt","dirt","dirt","dirt"}).setHardness(2.5F).setResistance(5.0F).setBlockName("granitePillars");
