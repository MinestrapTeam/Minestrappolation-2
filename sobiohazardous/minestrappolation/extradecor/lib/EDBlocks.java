...
{	
	...
	public static void createBlocks()
	{
		...
		graniteBlocks = new BlockMulti(Material.rock, new String[]{MAssetManager.getEDStonecutterTexture("Granite_Chiseled_0_0"), MAssetManager.getEDStonecutterTexture("Granite_Chiseled_0_Bronze"), MAssetManager.getEDStonecutterTexture("Granite_Chiseled_0_Meurodite"), MAssetManager.getEDStonecutterTexture("Granite_Chiseled_0_Steel"), MAssetManager.getEDStonecutterTexture("Granite_Chiseled_0_Tin"), MAssetManager.getEDStonecutterTexture("Granite_Refined_0_0"), MAssetManager.getEDStonecutterTexture("Granite_Refined_0_Bronze"), MAssetManager.getEDStonecutterTexture("Granite_Refined_0_Meurodite"), MAssetManager.getEDStonecutterTexture("Granite_Refined_0_Steel"), MAssetManager.getEDStonecutterTexture("Granite_Refined_0_Tin"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_0"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_Bronze"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_Meurodite"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_Steel"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_Tin")}).setBlockName("graniteBlocks").setHardness(2.5F).setResistance(5.0F);
		granitePillars = new BlockMultiPillar(Material.rock, new String[]{MAssetManager.getEDStonecutterTexture("Granite_Pillar_Side_0"), MAssetManager.getEDStonecutterTexture("Granite_Pillar_Side_Bronze"), MAssetManager.getEDStonecutterTexture("Granite_Pillar_Side_Meurodite"), MAssetManager.getEDStonecutterTexture("Granite_Pillar_Side_Steel"), MAssetManager.getEDStonecutterTexture("Granite_Pillar_Side_Tin")}, new String[]{MAssetManager.getEDStonecutterTexture("Granite_Pillar_Top_0"), MAssetManager.getEDStonecutterTexture("Granite_Pillar_Top_Bronze"), MAssetManager.getEDStonecutterTexture("Granite_Pillar_Top_Meurodite"), MAssetManager.getEDStonecutterTexture("Granite_Pillar_Top_Steel"), MAssetManager.getEDStonecutterTexture("Granite_Pillar_Top_Tin")}).setBlockName("granitePillars").setHardness(2.5F).setResistance(5.0F);
		graniteRoads = new BlockMultiRoad(Material.rock, new String[]{MAssetManager.getEDStonecutterTexture("Granite_Road_Side_0"), MAssetManager.getEDStonecutterTexture("Granite_Road_Side_Bronze"), MAssetManager.getEDStonecutterTexture("Granite_Road_Side_Meurodite"), MAssetManager.getEDStonecutterTexture("Granite_Road_Side_Steel"), MAssetManager.getEDStonecutterTexture("Granite_Road_Side_Tin")}, new String[]{MAssetManager.getEDStonecutterTexture("Granite_Refined_0_Tin"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_0"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_Bronze"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_Meurodite"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_Steel"), MAssetManager.getEDStonecutterTexture("Granite_Tiles_0_Tin")}, new String[]{"dirt" ,"dirt","dirt","dirt","dirt"}).setHardness(2.5F).setResistance(5.0F).setBlockName("granitePillars");
		//TODO Fix textures and add rest of blocks
	}
