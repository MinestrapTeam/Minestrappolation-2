package sobiohazardous.minestrappolation.api.brewing.brewing;
...
import sobiohazardous.minestrappolation.api.brewing.api.IBrewingAttribute;
...
import sobiohazardous.minestrappolation.api.potion.*;
...
public class Brewing implements Comparable<Brewing>
{
	...
	public boolean isBadEffect()
	{
		if (this.getEffect() != null)
		{
			...
			if (Minestrappolation.CLASHSOFT_API())
			{
				if (Potion.potionTypes[this.getEffect().getPotionID()] instanceof MPotion)
				{
					return ((MPotion) Potion.potionTypes[this.getEffect().getPotionID()]).getIsGoodOrNotGoodEffect();
				}
			}
		}
		return false;
	...
	{
		for (IIngredientHandler handler : Minestrappolation.ingredientHandlers)
		{
