...
public class PotionType implements Comparable<PotionType>
{
	...
	public boolean isBadEffect()
	{
		if (this.hasEffect())
		{
			...
			if (this.getPotion() instanceof sobiohazardous.minestrappolation.api.potion.MPotion)
			{
					return ((sobiohazardous.minestrappolation.api.potion.MPotion) this.getPotion()).isBadEffect();
			}
		}
		return false;
	}
