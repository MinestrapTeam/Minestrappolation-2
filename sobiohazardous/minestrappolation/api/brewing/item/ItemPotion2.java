...
import sobiohazardous.minestrappolation.api.brewing.brewing.PotionBase;
...
public class ItemPotion2 extends Item
{
	...
	{
		return iconName.equals("bottle_drinkable") ? Minestrappolation.potion2.bottle : (iconName.equals("bottle_splash") ? Minestrappolation.potion2.splashbottle : (iconName.equals("overlay") ? Minestrappolation.potion2.liquid : null));
	}
			...
			if (!potionTypes.isEmpty())
			{
				...
				if (MAPIConfig.advancedPotionInfo && Keyboard.isKeyDown(Keyboard.KEY_CAPITAL))
				{
					...
					if (potionTypes.size() > 1)
					{
						...
						builder.delete(4, builder.length());
						builder.append(I18n.getString("potion.averageamplifier")).append(": ").append(averageAmplifier);
						list.add(builder.toString());
						
						builder.delete(4, builder.length());
						builder.append(I18n.getString("potion.maxamplifier")).append(": ").append(averageAmplifier);
						list.add(builder.toString());
