...
public class EOOreGenerator implements IWorldGenerator
{
	...
	public void generateSurface(World world, Random rand, int chunkx, int chunkz)
	{
		...
		(new WorldGenMinable(ExtraOres.UraniumOre.blockID, 3)).generate(world, rand, i2, j2, k2); 
		}
		...
		(new WorldGenMinable(ExtraOres.PlutoniumOre.blockID, 3)).generate(world, rand, i3, j3, k3);
		}
		//Titanium Ore
		for(int q = 0; q<8; q++)
		{
		...
		(new WorldGenMinable(ExtraOres.TitaniumOre.blockID, 3)).generate(world, rand, i4, j4, k4);
		}
		//torite ore
		...
		if(biome2 instanceof BiomeGenJungle)
		{
		    ...
		    (new WorldGenMinable(ExtraOres.ToriteOre.blockID, 4)).generate(world, rand, i5, j5, k5);
		    }
		}
		//sunstone ore
		for(int h = 0; h<10; h++)
		...
		(new WorldGenMinable(ExtraOres.SunstoneOre.blockID, 3)).generate(world, rand, i5, j5, k5);
		}
		//granite
		for(int h = 0; h<12; h++)
		{
		...
		(new WorldGenMinable(ExtraOres.Granite.blockID, 20)).generate(world, rand, i5, j5, k5);
		}
		//quartzite
		for(int h = 0; h<16; h++)
		{
		...
		(new WorldGenDesert(ExtraOres.Quartzite.blockID, 10)).generate(world, rand, i5, j5, k5);
		}
		//copper ore
		for(int h = 0; h<13; h++)
		{
		...
		(new WorldGenMinable(ExtraOres.CopperOre.blockID, 10)).generate(world, rand, i5, j5, k5);
		}	
		//tin ore
		for(int h = 0; h<14; h++)
		{
		...
		(new WorldGenMinable(ExtraOres.TinOre.blockID, 11)).generate(world, rand, i5, j5, k5);
		}	
		//invincium
		for(int h = 0; h<400; h++)
		{
		...
		(new WorldGenInvincium(ExtraOres.Invincium.blockID, 20)).generate(world, rand, i5, j5, k5);
		}	
		//Radiant Quartz
		for(int q = 0; q<9; q++)
		{
		...
		(new WorldGenMinable(ExtraOres.RadiantQuartzOre.blockID, 5)).generate(world, rand, i4, j4, k4);
		}
	}
