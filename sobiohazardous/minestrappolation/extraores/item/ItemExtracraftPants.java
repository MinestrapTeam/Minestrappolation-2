...
public class ItemExtracraftPants extends ItemArmor
{
	private String texture;
	public ItemExtracraftPants(int par1, String texture, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
	{
