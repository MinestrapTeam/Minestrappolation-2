...
public class BlockCropRice extends BlockFlower
{
    ...
    public BlockCropRice(int par1, int textureNumbers, String texturePrefix)
    {
        super(par1);
    ...
    {
        return ExtraFoods.riceSeed.itemID;
    }
