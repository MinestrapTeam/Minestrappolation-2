...
import sobiohazardous.minestrappolation.brewingapi.brewing.BrewingBase;
import sobiohazardous.minestrappolation.brewingapi.brewing.BrewingList;
import sobiohazardous.minestrappolation.brewingapi.brewing.PotionUtils;
...
public class ItemPotion2 extends Item
{
	...
	public int getColorFromItemStack(ItemStack par1ItemStack, int par2)
	{
		...
		{
			if (Minestrappolation.potion2.isWater(par1ItemStack.getItemDamage()))
			{
				return 0x0C0CFF;
			}
		...
		if (!isWater(par1ItemStack.getItemDamage()))
		{
			...
			if (var5 != null && !var5.isEmpty())
			{
				...
				for (int i = 0; i < var5.size(); i++)
				{
					...
					if (var7.getEffect() != null && Potion.potionTypes[var7.getEffect().getPotionID()] instanceof sobiohazardous.minestrappolation.api.potion.MPotion && ((sobiohazardous.minestrappolation.api.potion.MPotion) (Potion.potionTypes[var7.getEffect().getPotionID()])).getCustomColor() >= 0)
					{
						int c = ((sobiohazardous.minestrappolation.api.potion.MPotion) Potion.potionTypes[var7.getEffect().getPotionID()]).getCustomColor();
