...
public class MelterRecipes
{
	...
	{
		this.meltr.loadModdedMelter();
		this.addSmelting(Blocks.cobblestone, new ItemStack(Items.lava_bucket, 1, 0), 0.4F);
		this.addSmelting(Blocks.mossy_cobblestone, new ItemStack(Items.lava_bucket, 1, 0), 0.6F);
		this.addSmelting(Blocks.gravel, new ItemStack(Items.lava_bucket, 1, 0), 0.2F);
		this.addSmelting(Blocks.stone, new ItemStack(Items.lava_bucket, 1, 0), 0.5F);
		this.addSmelting(Blocks.stonebrick, new ItemStack(Items.lava_bucket, 1, 0), 0.8F);
		this.addSmelting(Blocks.snow, new ItemStack(Items.water_bucket, 1, 0), 0.6F);
		this.addSmelting(Blocks.ice, new ItemStack(Items.water_bucket, 1, 0), 0.7F);
		this.addSmelting(Blocks.cobblestone_wall, new ItemStack(Items.lava_bucket, 1, 0), 0.7F);
		// addSmelting(Blocks.obsidian, new
		// ItemStack(EOItemManager.bucketMagma,1,0), 0.7F);
		// addSmelting(Blocks.bedrock, new
		// ItemStack(EOItemManager.bucketMagma,1,0), 0.7F);
		this.addSmelting(EOBlocks.Granite, new ItemStack(Items.lava_bucket, 1, 0), 0.7F);
		this.addSmelting(Blocks.glowstone, new ItemStack(EOBlocks.glowGlass), 0.7F);
	...
	{
		this.melterList.put(input, itemStack);
	...
	{
		this.metal.put(Arrays.asList(id, meta), itemStack);
