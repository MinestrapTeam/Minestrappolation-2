...
public class EOBlocks
{
	...
	public static void init()
	{
		...
		Granite = new EOBlock(Material.rock).setHardness(5F).setResistance(9F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("graniteRaw").setBlockTextureName(MAssetManager.getEOTextureSC("Granite_Raw_0_0"));
		GameRegistry.registerBlock(Granite, "granite");
		GraniteBrick = new EOBlock(Material.rock).setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("graniteBricks").setBlockTextureName(MAssetManager.getEOTextureSC("Granite_Bricks_0_0"));
		GameRegistry.registerBlock(GraniteBrick, "brickGranite");
		Quartzite = new EOBlock(Material.rock).setHardness(5F).setResistance(9F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("desertQuartzRaw").setBlockTextureName(MAssetManager.getEOTextureSC("DesertQuartz_Raw_0_0"));
		GameRegistry.registerBlock(Quartzite, "quartzDesert");
		QuartziteTile = new EOBlock(Material.rock).setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("desertQuartzTilesRaw").setBlockTextureName(MAssetManager.getEOTextureSC("DesertQuartz_TilesRaw_0_0"));
		GameRegistry.registerBlock(QuartziteTile, "quartzDesertTile");
		SmoothQuartzite = new EOBlock(Material.rock).setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("desertQuartzRefined").setBlockTextureName(MAssetManager.getEOTextureSC("DesertQuartz_Refined_0_0"));
		GameRegistry.registerBlock(SmoothQuartzite, "quartzDesertSmooth");
		PillarQuartzite = new BlockDesertQuartzPillar().setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("desertQuartzPillar").setBlockTextureName(MAssetManager.getEOTextureSC("DesertQuartz_Pillar_Side_0"));
		GameRegistry.registerBlock(PillarQuartzite, "quartzDesertPillar");
		ChiseledQuartzite = new BlockDesertQuartzChiseled().setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("desertQuartzChiseled").setBlockTextureName(MAssetManager.getEOTextureSC("DesertQuartz_Chiseled_Side_0"));
		GameRegistry.registerBlock(ChiseledQuartzite, "quartzDesertChiseled");
		SmoothQuartzTile = new EOBlock(Material.rock).setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("desertQuartzTilesRefined").setBlockTextureName(MAssetManager.getEOTextureSC("DesertQuartz_TilesRefined_0_0"));
		...
		TinPlatedCobble = new EOBlock(Material.rock).setHardness(2.0F).setResistance(10.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("stoneCobbledTin").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_Cobbled_0_Tin"));
		GameRegistry.registerBlock(TinPlatedCobble, "cobbleTin");
		TinPlatedMossy = new EOBlock(Material.rock).setHardness(2.0F).setResistance(10.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("stoneCobbledMossyTin").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_CobbledMossy_0_Tin"));
		GameRegistry.registerBlock(TinPlatedMossy, "cobbleMossyTin");
		TinPlatedStoneBrick = new EOBlock(Material.rock).setHardness(1.5F).setResistance(10.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("stoneBricksTin").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_Bricks_0_Tin"));
		GameRegistry.registerBlock(TinPlatedStoneBrick, "stoneBrickTin");
		TinPlatedChiseled = new EOBlock(Material.rock).setHardness(1.5F).setResistance(10.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("stoneChiseledTin").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_Chiseled_0_Tin"));
		GameRegistry.registerBlock(TinPlatedChiseled, "stoneBrickChiseledTin");
		TinPlatedGranite = new EOBlock(Material.rock).setHardness(6F).setResistance(10.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("graniteBricksTin").setBlockTextureName(MAssetManager.getEOTextureSC("Granite_Bricks_0_Tin"));
		...
		BronzePlatedCobble = new EOBlock(Material.rock).setHardness(2.0F).setResistance(30.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_BronzeCobble").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_Cobbled_0_Bronze"));
		GameRegistry.registerBlock(BronzePlatedCobble, "cobbleBronze");
		BronzePlatedMossy = new EOBlock(Material.rock).setHardness(2.0F).setResistance(30.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_BronzeMossy").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_CobbledMossy_0_Bronze"));
		GameRegistry.registerBlock(BronzePlatedMossy, "cobbleMossyBronze");
		BronzePlatedStoneBrick = new EOBlock(Material.rock).setHardness(1.5F).setResistance(30.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_BronzeStoneBrick").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_Bricks_0_Bronze"));
		GameRegistry.registerBlock(BronzePlatedStoneBrick, "stoneBrickBronze");
		BronzePlatedChiseled = new EOBlock(Material.rock).setHardness(1.5F).setResistance(30.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_BronzeChiseled").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_Chiseled_0_Bronze"));
		GameRegistry.registerBlock(BronzePlatedChiseled, "stoneBrickChiseledBronze");
		BronzePlatedGranite = new EOBlock(Material.rock).setHardness(6F).setResistance(30.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_BronzeGraniteBrick").setBlockTextureName(MAssetManager.getEOTextureSC("Granite_Bricks_0_Bronze"));
		...
		SteelPlatedCobble = new EOBlock(Material.rock).setHardness(2.0F).setResistance(20.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_SteelCobble").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_Cobbled_0_Steel"));
		GameRegistry.registerBlock(SteelPlatedCobble, "cobbleSteel");
		SteelPlatedMossy = new EOBlock(Material.rock).setHardness(2.0F).setResistance(20.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_SteelMossy").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_CobbledMossy_0_Steel"));
		GameRegistry.registerBlock(SteelPlatedMossy, "cobbleMossySteel");
		SteelPlatedStoneBrick = new EOBlock(Material.rock).setHardness(1.5F).setResistance(20.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_SteelStoneBrick").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_Bricks_0_Steel"));
		GameRegistry.registerBlock(SteelPlatedStoneBrick, "stoneBrickSteel");
		SteelPlatedChiseled = new EOBlock(Material.rock).setHardness(1.5F).setResistance(20.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_SteelChiseled").setBlockTextureName(MAssetManager.getEOTextureSC("Stone_Chiseled_0_Steel"));
		GameRegistry.registerBlock(SteelPlatedChiseled, "stoneBrickChiseledSteel");
		SteelPlatedGranite = new EOBlock(Material.rock).setHardness(6F).setResistance(20.0F).setCreativeTab(tabOresBlocks).setStepSound(Block.soundTypeStone).setBlockName("block_SteelGraniteBrick").setBlockTextureName(MAssetManager.getEOTextureSC("Granite_Bricks_0_Steel"));
		...
		SmoothRadiantQuartz = new EOBlock(Material.rock).setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setLightLevel(0.5F).setBlockName("block_SmoothRadiantQuartz").setBlockTextureName(MAssetManager.getEOTextureSC("RadiantQuartz_Raw_0_0"));
		GameRegistry.registerBlock(SmoothRadiantQuartz, "quartzRadiantSmooth");
		ChiseledRadiantQuartz = new EOBlock(Material.rock).setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setLightLevel(0.5F).setBlockName("block_ChiseledRadiantQuartz").setBlockTextureName(MAssetManager.getEOTextureSC("RadiantQuartz_Chiseled_0_0"));
