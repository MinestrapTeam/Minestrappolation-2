...
import sobiohazardous.mods.minestrappolation.extraores.block.BlockDoorOverwrite;
...
import sobiohazardous.mods.minestrappolation.extraores.block.BlockMagma;
...
import sobiohazardous.mods.minestrappolation.extraores.block.BlockPinkChiseled;
import sobiohazardous.mods.minestrappolation.extraores.block.BlockPinkPillar;
...
import sobiohazardous.mods.minestrappolation.extraores.block.BronzePlatedCobbleSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.BronzePlatedGraniteBrickSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.BronzePlatedStoneBrickSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.EOBlock;
import sobiohazardous.mods.minestrappolation.extraores.block.EOBlockStairs;
import sobiohazardous.mods.minestrappolation.extraores.block.GraniteBrickSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.PinkQuartzSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.RadiantQuartzSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.SteelPlatedCobbleSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.SteelPlatedGraniteBrickSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.SteelPlatedStoneBrickSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.TinPlatedCobbleSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.TinPlatedGraniteBrickSlab;
import sobiohazardous.mods.minestrappolation.extraores.block.TinPlatedStoneBrickSlab;
...
import sobiohazardous.mods.minestrappolation.extraores.itemblocks.EOItemSlab;
...
{	
	...
	public static void addBlocks()
	{
		...
		PillarQuartzite = (new BlockPinkPillar()).setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("desertQuartzPillar").setBlockTextureName(MAssetManager.getEOStonecutterTexture("DesertQuartz_Pillar_Side_0"));
		GameRegistry.registerBlock(PillarQuartzite, "quartzDesertPillar");
		ChiseledQuartzite = (new BlockPinkChiseled()).setHardness(6F).setResistance(10F).setStepSound(Block.soundTypeStone).setCreativeTab(tabOresBlocks).setBlockName("desertQuartzChiseled").setBlockTextureName(MAssetManager.getEOStonecutterTexture("DesertQuartz_Chiseled_Side_0"));
