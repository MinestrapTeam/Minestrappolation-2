...
public class BlockDoorOverwrite extends BlockDoor implements ITileEntityProvider
{
	...
	{
		this.te = (TileEntityLocked) par1World.getTileEntity(par2, par3, par4);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			if (TileEntityLocked.locked && par5EntityPlayer.getItemInUse() != new ItemStack(EOItems.steelLock))
			{
				MChatMessageHandler.sendChatToPlayer(par5EntityPlayer, "Locked by: " + TileEntityLocked.player);
			}
