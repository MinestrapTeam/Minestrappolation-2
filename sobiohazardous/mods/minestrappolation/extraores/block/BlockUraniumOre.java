...
public class BlockUraniumOre extends Block
{
		...
		else
		{
			while (var6.hasNext())
			{
				...
				if (EOConfig.shouldOresEffect)
				{
					...
					this.living.addPotionEffect(new PotionEffect(Potion.poison.getId(), 120, 1, false));
		...
		else
		{
			while (var8.hasNext())
			{
				if (EOConfig.shouldOresEffect)
				{
					...
					this.zombie.addPotionEffect(new PotionEffect(Potion.moveSpeed.getId(), 180, 1, false));
					this.zombie.addPotionEffect(new PotionEffect(Potion.damageBoost.getId(), 180, 0, false));
					// varEntityLiving.addPotionEffect(new
					// PotionEffect(Potion.poison.getId(),200,10));
				}
			}
	...
	{
		this.dropXpOnBlockBreak(par1World, par2, par3, par4, this.rand.nextInt(6) + 1); // the
																						// 1
																						// is
																						// the
																						// amount
