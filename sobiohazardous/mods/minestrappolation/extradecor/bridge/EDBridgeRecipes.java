...
public class EDBridgeRecipes
{
	...
	// static Block sunstone = GameRegistry.findBlock(MAPIReference.MODID_EO,
	// "Sunstone");
	...
	public static void loadBridgeRecipes() throws Exception
	{
		if (hasExtraOres)
		{
			...
			GameRegistry.addRecipe(new ItemStack(EDBlocks.stoneLamp, 8, 1), new Object[] { "SSS", "SGS", "SSS", Character.valueOf('S'), new ItemStack(EDBlocks.stones, 1, 1), Character.valueOf('G'), sobiohazardous.mods.minestrappolation.extraores.lib.EOBlocks.Sunstone });
			
			GameRegistry.addRecipe(new ItemStack(EDBlocks.bedrockBrick, 4), new Object[] { "SS", "SS", Character.valueOf('S'), Blocks.bedrock });
		}
	}
	
	// EXPERIMENTAL - I Tried to use reflection to refer to other mods possibly
	// loaded or not. it failed, and turns out, forge already has it.\\
	
	/**
	 * Used for getting blocks and items from classes if they do not exist
	 * (reflection)
	 * 
	 * @param pkg
	 ...
	 * @param blockOrItemName
	 *            the block of item you are wanting to reference
