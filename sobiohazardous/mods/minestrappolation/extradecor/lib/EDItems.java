...
import sobiohazardous.mods.minestrappolation.extradecor.item.ItemGDoor;
...
public class EDItems
{
	...
	{
		/*
		 * old 1.6.4 code Item.itemsList[EDBlockManager.stoneLamp.blockID] =
		 * (new ItemMultiTextureTile(EDBlockManager.stoneLamp.blockID - 256,
		 * EDBlockManager.stoneLamp,
		 * BlockStoneLamp.lampType)).setUnlocalizedName("stoneLamp");
		 * Item.itemsList[EDBlockManager.woodPanel.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.woodPanel.blockID - 256,
		 * EDBlockManager.woodPanel,
		 * BlockWoodPanel.woodType)).setUnlocalizedName("woodPanel");
		 * Item.itemsList[EDBlockManager.woodBeveled.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.woodBeveled.blockID - 256,
		 * EDBlockManager.woodBeveled,
		 * BlockWoodBeveled.woodType)).setUnlocalizedName("woodBeveled");
		 * Item.itemsList[EDBlockManager.sandstoneBricks.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.sandstoneBricks.blockID - 256,
		 * EDBlockManager.sandstoneBricks,
		 * BlockSandstoneBrick.sandType)).setUnlocalizedName("sandstoneBrick");
		 * Item.itemsList[EDBlockManager.woodBoards.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.woodBoards.blockID - 256,
		 * EDBlockManager.woodBoards,
		 * BlockWoodBoards.woodType)).setUnlocalizedName("woodBoards");
		 * Item.itemsList[EDBlockManager.stainedBrick.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.stainedBrick.blockID - 256,
		 * EDBlockManager.stainedBrick,
		 * BlockStainedBrick.brickType)).setUnlocalizedName("stainedBrick");
		 * Item.itemsList[EDBlockManager.edgeStoneBrickCorner.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.edgeStoneBrickCorner.blockID -
		 * 256,
		 * EDBlockManager.edgeStoneBrickCorner,BlockEdgeStoneCorner.cType)).
		 * setUnlocalizedName("stainedBrick");
		 * Item.itemsList[EDBlockManager.woodPlanksMossy.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.woodPlanksMossy.blockID - 256,
		 * EDBlockManager.woodPlanksMossy,
		 * BlockMossyWood.woodType)).setUnlocalizedName("woodPlanksMossy");
		 * Item.itemsList[EDBlockManager.stones.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.stones.blockID - 256,
		 * EDBlockManager
		 * .stones,BlockStones.brickType)).setUnlocalizedName("Stones");
		 * Item.itemsList[EDBlockManager.endstone.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.endstone.blockID - 256,
		 * EDBlockManager
		 * .endstone,BlockEndStone.bType)).setUnlocalizedName("EndStone");
		 * Item.itemsList[EDBlockManager.Tiles.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.Tiles.blockID - 256,
		 * EDBlockManager
		 * .Tiles,BlockTiles.brickType)).setUnlocalizedName("Tiles");
		 * Item.itemsList[EDBlockManager.Goblet.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.Goblet.blockID - 256,
		 * EDBlockManager.Goblet,BlockGoblet.g)).setUnlocalizedName("Goblets");
		 * //this for testing unlimited metadata
		 * //Item.itemsList[EDBlockManager.infertileDirt.blockID] = (new
		 * ItemMultiTextureTile(EDBlockManager.infertileDirt.blockID - 256,
		 * EDBlockManager
		 * .infertileDirt,Block100.brickType)).setUnlocalizedName("test");
		 * //TODO Forms of adding slabs
		 * Item.itemsList[EDBlockManager.woodBoardsSingleSlab.blockID] = (new
		 * ItemSlab(EDBlockManager.woodBoardsSingleSlab.blockID - 256,
		 * (BlockSlab)EDBlockManager.woodBoardsSingleSlab,
		 * (BlockSlab)EDBlockManager.woodBoardsDoubleSlab, false));
		 */
	}
