...
public class EDOreGenerator implements IWorldGenerator
{
	...
	public void generateSurface(World world, Random rand, int chunkx, int chunkz)
	{
		...
		(new WorldGenSandstone(EDBlocks.sandstoneBricks, 3)).generate(world, rand, i1, j1, k1); //5 = how much in a vain
		}
		...
		(new WorldGenSandstone(EDBlocks.sandstoneBricks, 4)).generate(world, rand, i1, j1, k1); //5 = how much in a vain
		}
		...
		(new WorldGenSandstone(EDBlocks.woodPlanksMossy, 3)).generate(world, rand, i1, j1, k1); //5 = how much in a vain
		}
