...
public class EDPriestTradeHandler implements IVillageTradeHandler
{
	...
	{
		recipes.add(new MerchantRecipe(new ItemStack(EDBlocks.sandstoneBricks, 1, 3), new ItemStack(Items.emerald, 5)));
		
		recipes.add(new MerchantRecipe(new ItemStack(EDBlocks.sandstoneBricks, 1, 4), new ItemStack(Items.emerald, 5)));
	}
}
