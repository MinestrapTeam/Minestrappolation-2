...
public class MItemPickaxe extends ItemPickaxe
{
	...
	public void registerIcons(IIconRegister par1IconRegister)
	{
		...
		this.overlayIcon = par1IconRegister.registerIcon(MAssetManager.getEOTexture("overlayToolPickBeonze"));
		this.overlayIcon2 = par1IconRegister.registerIcon(MAssetManager.getEOTexture("overlayToolPickBronze2"));
	}
