...
public class MItemTool extends ItemTool
{
	...
	public MItemTool(float baseDamage, ToolMaterial material, ToolMaterial plateMaterial, Set<Block> blocks, String type, boolean ignites)
	{
	...
	public MItemTool(float baseDamage, ToolMaterial material, ToolMaterial plateMaterial, Set<Block> blocks, String type)
	{
	...
	public void registerIcons(IIconRegister iconRegister)
	{
		...
		this.overlayIcon = iconRegister.registerIcon(MAssetManager.getEOTexture(s + "Bronze"));
		this.overlayIcon2 = iconRegister.registerIcon(MAssetManager.getEOTexture(s + "Bronze2"));
	}
