...
import sobiohazardous.mods.minestrappolation.core.block.MBlockStone2;
...
public class MItemBlockStone2 extends ItemBlock
{
	private MBlockStone2	theBlock;
	
	public MItemBlockStone2(Block block)
	{
		super(block);
		
		if (block instanceof MBlockStone2)
			this.theBlock = (MBlockStone2) block;
	}
