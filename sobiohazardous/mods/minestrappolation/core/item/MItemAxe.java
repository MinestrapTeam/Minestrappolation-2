...
public class MItemAxe extends ItemAxe
{
	...
	public void registerIcons(IIconRegister par1IconRegister)
	{
		...
		this.overlayIcon = par1IconRegister.registerIcon(MAssetManager.getEOTexture("overlayToolAxeBronze"));
		this.overlayIcon2 = par1IconRegister.registerIcon(MAssetManager.getEOTexture("overlayToolAxeBronze2"));
