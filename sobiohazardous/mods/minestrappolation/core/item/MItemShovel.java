...
public class MItemShovel extends ItemSpade
{
	...
	public void registerIcons(IIconRegister par1IconRegister)
	{
		...
		this.overlayIcon = par1IconRegister.registerIcon(MAssetManager.getEOTexture("overlayToolShovelBronze"));
		this.overlayIcon2 = par1IconRegister.registerIcon(MAssetManager.getEOTexture("overlayToolShovelBronze2"));
	}
