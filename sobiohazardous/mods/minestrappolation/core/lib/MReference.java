...
public class MReference
{
	...
	public static final String	EO_MODID		= "ExtraOres";
	public static final String	EO_NAME			= "Extrapolated Ores";
	public static final String	EO_VERSION		= "1.5.1";
	
	public static final String	ED_MODID		= "ExtraDecor";
	public static final String	ED_NAME			= "Extrapolated Decor";
	public static final String	ED_VERSION		= "1.4.2";
	
	public static final String	EMD_MODID		= "ExtraMobDrops";
