...
{
	private static final ResourceLocation	craftingTableGuiTextures	= new ResourceLocation(MAssetManager.getMAPITexture("textures/gui/stonecutter.png"));
	...
	{
		this.fontRendererObj.drawString("Stonecutter", 28, 6, 4210752);
