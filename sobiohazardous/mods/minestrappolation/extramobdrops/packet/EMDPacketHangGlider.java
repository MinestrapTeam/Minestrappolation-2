...
public class EMDPacketHangGlider extends EMDPacket
{
	...
	public void handleClientSide(EntityPlayer player)
	{
		 ...
		 * EMDItemManager.hangGlider.getContainerItem(null)) {
		 * System.out.println("Running"); GL11.glPushMatrix(); ModelHangGlider m
		 * = new ModelHangGlider();
		 * Minecraft.getMinecraft().getTextureManager().bindTexture(new
		 * ResourceLocation("extramobdrops:textures/misc/hangGlider.png")); int
		 * tick = 0; tick++; float rotateYaw =
		 * EMDEventHandler.interpolateRotation(player.prevRotationYaw,
		 * player.rotationYaw, tick); GL11.glRotatef(rotateYaw, 0, -1, 0);
