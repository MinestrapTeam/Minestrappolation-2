...
public class BlockDoorOverwrite extends BlockContainer
{
    ...
    public BlockDoorOverwrite(int par1, Material par2Material)
    {
    ...
    {
    	te = (TileEntityLocked)par1World.getBlockTileEntity(par2, par3, par4);
    }
    ...
    {      
        if (this.blockMaterial == Material.iron)
        {
            ...
            {
            	par5EntityPlayer.addChatMessage("Locked by: " + te.player);
            }	
