...
public class TileEntityEdgeStoneCorner extends TileEntity
{
    ...
    public void updateEntity()
    {
		...
		if(this.worldObj.getBlock(this.xCoord, this.yCoord, this.zCoord+1) == Blocks.stonebrick  && this.worldObj.getBlock(this.xCoord, this.yCoord, this.zCoord-1) == Blocks.stonebrick  && this.worldObj.getBlock(this.xCoord+1, this.yCoord, this.zCoord) == Blocks.stonebrick ){
		    this.worldObj.setBlock(this.xCoord, this.yCoord, this.zCoord, EDBlocks.edgeStoneBrick );
		}else
		if(this.worldObj.getBlock(this.xCoord, this.yCoord, this.zCoord+1) == Blocks.stonebrick  && this.worldObj.getBlock(this.xCoord, this.yCoord, this.zCoord-1) == Blocks.stonebrick  && this.worldObj.getBlock(this.xCoord-1, this.yCoord, this.zCoord) == Blocks.stonebrick ){
			   this.worldObj.setBlock(this.xCoord, this.yCoord, this.zCoord, EDBlocks.edgeStoneBrick );
    ...
    /*	if(this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord+1) != Blocks.stonebrick  && this.worldObj.getBlockId(this.xCoord+1, this.yCoord, this.zCoord) != Blocks.stonebrick ){
