...
{	
	...
	public static void createBlocks()
	{
		...
		claySlabsSingle2 = (BlockMultiSlab) new BlockMultiSlab(false, new String[]{
				...
				}).setBlockName("claySlabsSingle2").setCreativeTab(Minestrappolation.creativeTabMAPI).setHardness(2.0F).setResistance(8.0F);
		claySlabsSingle3 = (BlockMultiSlab) new BlockMultiSlab(false, new String[]{
				...
				}).setBlockName("claySlabsSingle3").setCreativeTab(Minestrappolation.creativeTabMAPI).setHardness(2.0F).setResistance(8.0F);
		claySlabsSingle4 = (BlockMultiSlab) new BlockMultiSlab(false, new String[]{
				...
				}).setBlockName("claySlabsSingle4").setCreativeTab(Minestrappolation.creativeTabMAPI).setHardness(2.0F).setResistance(8.0F);
		...
		endstoneSlabSingle = (BlockMultiSlab) new BlockMultiSlab(false, new String[]{MAssetManager.getEDStonecutterTexture("Endstone_RawSlab_Side_0")}, new String[]{MAssetManager.getEDStonecutterTexture("Endstone_RawSlab_Top_0")}).setBlockName("endstoneSlabSingle").setHardness(1.5F).setResistance(2.0F).setCreativeTab(Minestrappolation.creativeTabMAPI);
