...
public class WorldGenMineshaftWood extends WorldGenerator
{
    ...
    public WorldGenMineshaftWood(int par1, int par1_5, int par2)
    {
        this(par1, par1_5, par2, Block.planks.blockID);
    }

    public WorldGenMineshaftWood(int par1, int par1_5, int par2, int par3)
    {
