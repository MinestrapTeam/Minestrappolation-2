...
public class BlockCropPepper extends BlockFlower
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;
    /**
     * Should be one less than amount of imgs because they start at 0
     */
    private int textureNumbers;
    private String texturePrefix;

    public BlockCropPepper(int par1, int textureNumbers, String texturePrefix)
    {
        super(par1);
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
    	...
    	if(itemstack != null && itemstack.itemID == Item.dyePowder.itemID)
    	{
    		...
    		{
    			par1World.setBlockMetadataWithNotify(par2, par3, par4, textureNumbers, 2);
    			itemstack.stackSize--;
    ...
    {
        return ExtraFoods.pepperSeed.itemID;
    }
    ...
    {
        return ExtraFoods.pepper.itemID;
    }
    ...
    {
        return par1 == textureNumbers ? this.getCropItem() : this.getSeedItem();
    }
    ...
    {
        this.iconArray = new Icon[textureNumbers +1];

        for (int i = 0; i < this.iconArray.length; ++i)
        {
            this.iconArray[i] = par1IconRegister.registerIcon("crazyfoods:" + texturePrefix + i);
        }
    }
}
