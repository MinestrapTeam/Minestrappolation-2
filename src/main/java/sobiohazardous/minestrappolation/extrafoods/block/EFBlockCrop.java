...
public class EFBlockCrop extends BlockFlower
{
    ...
    public EFBlockCrop(int par1, int textureNumbers, String texturePrefix, int seedId, int dropId)
    {
        super(par1);
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon(texturePrefix + i);
        }
    }
}
