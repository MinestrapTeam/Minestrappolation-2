 ...
 * @author Clashsoft
 */
public class MCBlockStoneCustom extends Block
{
	public String[] types;
	...
	public MCBlockStoneCustom(String[] types, String name, float baseHardness, boolean chiseledSided)
	{
		super(Material.rock);
		this.setCreativeTab(Minestrappolation.tabStoneDecor);
		this.name = name;
		this.baseHardness = baseHardness;
		this.chiseledSided = chiseledSided;
		this.types = types;
	}
	
	public MCBlockStoneCustom(String[] types, String name, float baseHardness)
	{
		this(types, name, baseHardness, true);
	}
	...
	public IIcon getIcon(int side, int metadata)
	{
		...
		else if (metadata == 6 && chiseledSided)
		{
			if (side == 0 || side == 1)
