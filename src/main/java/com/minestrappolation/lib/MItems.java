...
public class MItems
{
	...
	public static void init()
	{
		...
		Plutonium = new MCItem().setUnlocalizedName("plutonium").setCreativeTab(Minestrappolation.tabMaterials).setTextureName(MCAssetManager.getMineralTexture("plutonium_dust"));
		GameRegistry.registerItem(Plutonium, "dustPlutonium");
		Uranium = new MCItem().setUnlocalizedName("uranium").setCreativeTab(Minestrappolation.tabMaterials).setTextureName(MCAssetManager.getMineralTexture("uranium_dust"));
