...
public class MBlocks
{
	...
	public static void init()
	{
		...
		endstoneSlabSingle = (MCBlockMultiSlab) new MCBlockMultiSlab(false, new String[] { MCAssetManager.getSCTexture("Endstone_RawSlab_Side_0") }, new String[] { MCAssetManager.getSCTexture("Endstone_RawSlab_Top_0") }).setBlockName("endstoneSlabSingle").setHardness(1.5F).setResistance(2.0F).setCreativeTab(Minestrappolation.tabStoneDecor);
		...
		flintSlabSingle = (MCBlockMultiSlab) new MCBlockMultiSlab(false, new String[] { MCAssetManager.getSCTexture("Flint_RefinedSlab_Side_0") }, new String[] { MCAssetManager.getSCTexture("Flint_Refined_0_0") }).setBlockName("flintSlabSingle").setHardness(2.0F).setResistance(5.0F).setCreativeTab(Minestrappolation.tabStoneDecor);
		...
		graniteSlabSingle2 = (MCBlockMultiSlab) new MCBlockMultiSlab(false, new String[] { MCAssetManager.getSCTexture("Granite_RefinedSlab_Side_Tin") }, new String[] { MCAssetManager.getSCTexture("Granite_Refined_0_Tin") }).setBlockName("graniteSlabSingle2").setHardness(2.5F).setResistance(5.0F).setCreativeTab(Minestrappolation.tabStoneDecor);
		...
		redSandstoneSlabSingle = (MCBlockMultiSlab) new MCBlockMultiSlab(false, new String[] { MCAssetManager.getSCTexture("RedSandstone_RefinedSlab_Side_0") }, new String[] { MCAssetManager.getSCTexture("RedSandstone_Raw_Top_0") }).setBlockName("redSandstoneSlabSingle").setHardness(1.5F).setResistance(2.0F).setCreativeTab(Minestrappolation.tabStoneDecor);
