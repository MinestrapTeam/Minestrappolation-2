...
public class MCBlockMultiSlab extends BlockSlab
{
	...
	public MCBlockMultiSlab(boolean isDouble, String[] sideIconNames, String[] topIconNames)
	{
		this(Material.rock, isDouble, sideIconNames, topIconNames);
	}
	
	public MCBlockMultiSlab(Material material, boolean isDouble, String[] sideIconNames, String[] topIconNames)
	{
