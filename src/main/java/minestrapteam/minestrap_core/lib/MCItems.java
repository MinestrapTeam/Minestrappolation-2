...
public class MCItems
{
	...
	public static void init()
	{
		...
		brickColoredClay = new MCItemMulti("stonecutter", new String[] { MCAssetManager.getStonecutterTexture("black_clay_brick"), MCAssetManager.getStonecutterTexture("blue_clay_brick"), MCAssetManager.getStonecutterTexture("brown_clay_brick"), MCAssetManager.getStonecutterTexture("cyan_clay_brick"), MCAssetManager.getStonecutterTexture("grey_clay_brick"), MCAssetManager.getStonecutterTexture("green_clay_brick"), MCAssetManager.getStonecutterTexture("lightblue_clay_brick"), MCAssetManager.getStonecutterTexture("lime_clay_brick"), MCAssetManager.getStonecutterTexture("magenta_clay_brick"), MCAssetManager.getStonecutterTexture("orange_clay_brick"), MCAssetManager.getStonecutterTexture("pink_clay_brick"), MCAssetManager.getStonecutterTexture("purple_clay_brick"), MCAssetManager.getStonecutterTexture("red_clay_brick"), MCAssetManager.getStonecutterTexture("silver_clay_brick"), MCAssetManager.getStonecutterTexture("white_clay_brick"), MCAssetManager.getStonecutterTexture("yellow_clay_brick") }).setUnlocalizedName("clay_brick").setCreativeTab(Minestrappolation.tabStoneDecor);
