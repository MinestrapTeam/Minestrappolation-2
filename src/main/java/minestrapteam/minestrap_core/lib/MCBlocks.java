...
public class MCBlocks
{
	...
	public static void init()
	{
		...
		stone = MCBlockHelper.createStoneBlock(types_stone, "stone", 1.5F, 0, tab).setIsStone();
		stone2 = MCBlockHelper.createStoneBlock2(types_stone_2, "stone", 1.5F, 0, tab);
		stoneTin = MCBlockHelper.createStoneBlock("stone_tin", 1.7F, 1, tab).setIsStone();
		stoneTin2 = MCBlockHelper.createStoneBlock2("stone_tin", 1.7F, 1, tab);
		stoneBronze = MCBlockHelper.createStoneBlock("stone_bronze", 1.7F, 1, tab).setIsStone();
		stoneBronze2 = MCBlockHelper.createStoneBlock2("stone_bronze", 1.7F, 1, tab);
		stoneSteel = MCBlockHelper.createStoneBlock("stone_steel", 3F, 1, tab).setIsStone();
		stoneSteel2 = MCBlockHelper.createStoneBlock2("stone_steel", 3F, 1, tab);
		stoneMeurodite = MCBlockHelper.createStoneBlock("stone_meurodite", 2.3F, 2, tab).setIsStone();
		...
		netherrack = MCBlockHelper.createStoneBlock(types_netherrack, "netherrack", 0.4F, 1, tab).setIsNetherrack();
		...
		clay = MCBlockHelper.createStoneBlock(types_clay, "clay", 1.25F, 0, tab).setIsClay();
		clay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "clay", 1.25F, 0, tab);
		blackClay = MCBlockHelper.createStoneBlock(types_colored_clay, "black_clay", 1.25F, 0, tab).setIsClay();
		blackClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "black_clay", 1.25F, 0, tab);
		blueClay = MCBlockHelper.createStoneBlock(types_colored_clay, "blue_clay", 1.25F, 0, tab).setIsClay();
		blueClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "blue_clay", 1.25F, 0, tab);
		brownClay = MCBlockHelper.createStoneBlock(types_colored_clay, "brown_clay", 1.25F, 0, tab).setIsClay();
		brownClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "brown_clay", 1.25F, 0, tab);
		cyanClay = MCBlockHelper.createStoneBlock(types_colored_clay, "cyan_clay", 1.25F, 0, tab).setIsClay();
		cyanClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "cyan_clay", 1.25F, 0, tab);
		lightBlueClay = MCBlockHelper.createStoneBlock(types_colored_clay, "lightblue_clay", 1.25F, 0, tab).setIsClay();
		lightBlueClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "lightblue_clay", 1.25F, 0, tab);
		limeClay = MCBlockHelper.createStoneBlock(types_colored_clay, "lime_clay", 1.25F, 0, tab).setIsClay();
		limeClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "lime_clay", 1.25F, 0, tab);
		magentaClay = MCBlockHelper.createStoneBlock(types_colored_clay, "magenta_clay", 1.25F, 0, tab).setIsClay();
		magentaClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "magenta_clay", 1.25F, 0, tab);
		orangeClay = MCBlockHelper.createStoneBlock(types_colored_clay, "orange_clay", 1.25F, 0, tab).setIsClay();
		orangeClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "orange_clay", 1.25F, 0, tab);
		pinkClay = MCBlockHelper.createStoneBlock(types_colored_clay, "pink_clay", 1.25F, 0, tab).setIsClay();
		pinkClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "pink_clay", 1.25F, 0, tab);
		purpleClay = MCBlockHelper.createStoneBlock(types_colored_clay, "purple_clay", 1.25F, 0, tab).setIsClay();
		purpleClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "purple_clay", 1.25F, 0, tab);
		redClay = MCBlockHelper.createStoneBlock(types_colored_clay, "red_clay", 1.25F, 0, tab).setIsClay();
		redClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "red_clay", 1.25F, 0, tab);
		silverClay = MCBlockHelper.createStoneBlock(types_colored_clay, "silver_clay", 1.25F, 0, tab).setIsClay();
		silverClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "silver_clay", 1.25F, 0, tab);
		whiteClay = MCBlockHelper.createStoneBlock(types_colored_clay, "white_clay", 1.25F, 0, tab).setIsClay();
		whiteClay2 = MCBlockHelper.createStoneBlock2(types_clay_2, "white_clay", 1.25F, 0, tab);
		yellowClay = MCBlockHelper.createStoneBlock(types_colored_clay, "yellow_clay", 1.25F, 0, tab).setIsClay();
