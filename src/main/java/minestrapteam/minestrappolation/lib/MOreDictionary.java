...
public class MOreDictionary
{
	public static void load()
	{
		...
		OreDictionary.registerOre("plateTin", MItems.plateTinItem);
		OreDictionary.registerOre("blockBronze", MBlocks.bronzeBlock);
		OreDictionary.registerOre("ingotBronze", MItems.bronzeIngot);
		OreDictionary.registerOre("plateBronze", MItems.plateBronzeItem);
		...
		OreDictionary.registerOre("plateSteel", MItems.plateSteelItem);
		...
		OreDictionary.registerOre("plateMeurodite", MItems.plateMeuroditeItem);
