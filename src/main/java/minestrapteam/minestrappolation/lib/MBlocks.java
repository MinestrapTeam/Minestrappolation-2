...
import minestrapteam.minestrappolation.block.decor.*;
import minestrapteam.minestrappolation.block.glass.BlockGlassRefined;
import minestrapteam.minestrappolation.block.glass.BlockGlowGlass;
...
public class MBlocks
{
	...
	public static void load()
	{
		...
		CSBlocks.addBlock(edgeBricks, "edge_bricks");
		CSBlocks.addBlock(darkEdgeBricks, "dark_edge_bricks");
	...
	private static void addStoneBlocks()
	{
		...
		deepstone = MBlockHelper.createStoneBlock(types_redrock, "deepstone", 3F, 13.0F, 2, tab).setIsStone().setRoadWalkSpeed(1.25F);
		deepstone2 = MBlockHelper.createStoneBlock2(types_redrock_2, "deepstone", 3F, 13.0F, 2, tab);
