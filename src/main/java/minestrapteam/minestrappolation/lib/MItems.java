...
public class MItems
{
	...
	public static void init()
	{
		...
		animalBones = new MCItem().setTextureName(MCAssetManager.getMobTexture("animal_bones"));
		cowHoof = new MCItem().setTextureName(MCAssetManager.getMobTexture("cow_foot"));
		horn = new MCItem().setTextureName(MCAssetManager.getMobTexture("horn"));
		beakChicken = new MCItem().setTextureName(MCAssetManager.getFoodTexture("chicken_beak"));
		footChicken = new MCItem().setTextureName(MCAssetManager.getMobTexture("chicken_foot"));
		...
		amuletVaccam = new ItemAmuletVaccam().setCreativeTab(Minestrappolation.tabMisc).setTextureName(MCAssetManager.getMobTexture("horse_amulet"));
		amuletPullum = new ItemAmuletPullum().setCreativeTab(Minestrappolation.tabMisc).setTextureName(MCAssetManager.getMobTexture("chicken_amulet"));
		amuletOves = new ItemAmuletOves().setCreativeTab(Minestrappolation.tabMisc).setTextureName(MCAssetManager.getMobTexture("sheep_amulet"));
		wingSinew = new MCItem().setTextureName(MCAssetManager.getMobTexture("wing_sinew"));
	...
	public static void setHarvestLevels()
	{
		...
		MBlocks.bedrock2.setHarvestLevel("pickaxe", 5);
