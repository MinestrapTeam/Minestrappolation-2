...
public class MItems
{
	...
	public static void init()
	{
		...
		snout = new MCItemFood(3, 0.2F).setPotionEffect(Potion.hunger.id, 10 * 20, 1, 0.25F).setTextureName(MCAssetManager.getMobTexture("snout")).setCreativeTab(Minestrappolation.tabFood);
		...
		friedBread = new MCItemFood(10, 0.6F).setPotionEffect(Potion.hunger.id, 15 * 20, 1, 0.4F).setTextureName(MCAssetManager.getFoodTexture("fried_bread")).setCreativeTab(Minestrappolation.tabFood);
		friedCarrot = new MCItemFood(8, 0.6F).setPotionEffect(Potion.hunger.id, 15 * 20, 1, 0.4F).setTextureName(MCAssetManager.getFoodTexture("fried_carrot")).setCreativeTab(Minestrappolation.tabFood);
		friedCookie = new MCItemFood(8, 0.6F).setPotionEffect(Potion.hunger.id, 15 * 20, 1, 0.4F).setTextureName(MCAssetManager.getFoodTexture("fried_cookie")).setCreativeTab(Minestrappolation.tabFood);
		friedFlesh = new MCItemFood(8, 0.6F).setPotionEffect(Potion.hunger.id, 15 * 20, 1, 0.4F).setTextureName(MCAssetManager.getFoodTexture("fried_flesh")).setCreativeTab(Minestrappolation.tabFood);
		animalBones = new MCItem().setTextureName(MCAssetManager.getMobTexture("animal_bones")).setCreativeTab(Minestrappolation.tabFood);
		cowHoof = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("cow_foot"));
		horn = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("horn"));
		beakChicken = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getFoodTexture("chicken_beak"));
		footChicken = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("chicken_foot"));
		chickenWingRaw = new MCItemFood(1, 0.1F).setPotionEffect(Potion.hunger.id, 10 * 20, 1, 0.3F).setTextureName(MCAssetManager.getFoodTexture("chicken_wing_raw")).setCreativeTab(Minestrappolation.tabFood);
		chickenWingCooked = new MCItemFood(4, 0.65F).setTextureName(MCAssetManager.getFoodTexture("chicken_wing_cooked")).setCreativeTab(Minestrappolation.tabFood);
		lambchopRaw = new MCItemFood(3, 0.2F).setTextureName(MCAssetManager.getFoodTexture("lamb_chop_raw")).setCreativeTab(Minestrappolation.tabFood);
		...
		sheepHoof = new MCItem().setTextureName(MCAssetManager.getMobTexture("sheep_hoof")).setCreativeTab(Minestrappolation.tabFood);
		...
		infectiousFungus = new ItemInfectiousFungus(0, 0F).setTextureName(MCAssetManager.getMobTexture("infectious_fungus")).setCreativeTab(Minestrappolation.tabFood);
		airSack = new ItemAirSack().setTextureName(MCAssetManager.getMobTexture("air_sack")).setCreativeTab(Minestrappolation.tabFood);
		whisker = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("whisker"));
		catEye = new ItemCatEye(0, 0.0F).setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("cat_eye"));
		wolfHide = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("wolf_hide"));
		...
		legSpider = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("spider_leg"));
		poisonSack = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("poison_sack"));
		guano = new ItemGuano().setTextureName(MCAssetManager.getTexture("guano")).setCreativeTab(Minestrappolation.tabFood);
		carcassSilverfish = new MCItem().setTextureName(MCAssetManager.getMobTexture("silverfish_carcass")).setCreativeTab(Minestrappolation.tabFood);
		hideCreeper = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("creeper_hide"));
		slimeCore = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("slime_core"));
		enderCore = new ItemEnderCore(0, 0).setTextureName(MCAssetManager.getMobTexture("ender_core")).setCreativeTab(Minestrappolation.tabFood);
		ghastTentacle = new ItemGhastTentacle().setTextureName(MCAssetManager.getMobTexture("ghast_tentacle")).setCreativeTab(Minestrappolation.tabFood);
		...
		horseHair = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("horse_hair"));
		genes = new ItemGene();
		charms = new ItemCharm().setCreativeTab(Minestrappolation.tabFood);
		amuletPorcum = new ItemAmuletPorcum().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("pig_amulet"));
		amuletVaccam = new ItemAmuletVaccam().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("horse_amulet"));
		amuletPullum = new ItemAmuletPullum().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("chicken_amulet"));
		amuletOves = new ItemAmuletOves().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("sheep_amulet"));
		wingSinew = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("wing_sinew"));
		wingSegment = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getTexture("hangglider_segment"));
		...
		enderAura = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("ender_aura"));
		ghastlySoul = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getDrinkTexture("ghast_soul_bottle"));
		witheredBone = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("wither_bone"));
		horseHairFibre = new MCItem().setCreativeTab(Minestrappolation.tabFood).setTextureName(MCAssetManager.getMobTexture("horse_hair_fibre"));
