...
public class ItemFishFoodOverwrite extends MItemFood
{
    ...
    {
        return ItemFishFoodOverwrite.FishType.func_150978_a(p_150896_1_) == ItemFishFoodOverwrite.FishType.PUFFERFISH ? PotionHelper.field_151423_m : null;
    }

    @SideOnly(Side.CLIENT)
    public void registerIcons(IIconRegister p_94581_1_)
    {
        ItemFishFoodOverwrite.FishType[] afishtype = ItemFishFoodOverwrite.FishType.values();
    ...
    {
        ItemFishFoodOverwrite.FishType fishtype = ItemFishFoodOverwrite.FishType.func_150978_a(p_77849_1_);

        if (fishtype == ItemFishFoodOverwrite.FishType.PUFFERFISH)
        {
    ...
    public static enum FishType
    {
        ...
        public static ItemFishFoodOverwrite.FishType func_150974_a(int p_150974_0_)
        {
            ItemFishFoodOverwrite.FishType fishtype = (ItemFishFoodOverwrite.FishType)field_150983_e.get(Integer.valueOf(p_150974_0_));
            return fishtype == null ? COD : fishtype;
        }

        public static ItemFishFoodOverwrite.FishType func_150978_a(ItemStack p_150978_0_)
        {
            return p_150978_0_.getItem() instanceof ItemFishFoodOverwrite ? func_150974_a(p_150978_0_.getItemDamage()) : COD;
        }

        static
        {
            ItemFishFoodOverwrite.FishType[] var0 = values();
            int var1 = var0.length;

            for (int var2 = 0; var2 < var1; ++var2)
            {
                ItemFishFoodOverwrite.FishType var3 = var0[var2];
