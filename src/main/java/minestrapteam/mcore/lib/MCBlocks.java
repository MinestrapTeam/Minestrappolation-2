...
public class MCBlocks
{
	...
	public static void init()
	{
		...
		woodOakStairsBoards = MCBlockHelper.createStoneStair(woodOak, 1, tab_decor);
		...
		woodBirchStairsBoards = MCBlockHelper.createStoneStair(woodBirch, 1, tab_decor);
		...
		woodSpruceStairsBoards = MCBlockHelper.createStoneStair(woodSpruce, 1, tab_decor);
		...
		woodJungleStairsBoards = MCBlockHelper.createStoneStair(woodJungle, 1, tab_decor);
		...
		woodAcaciaStairsBoards = MCBlockHelper.createStoneStair(woodAcacia, 1, tab_decor);
		...
		woodDarkOakStairsBoards = MCBlockHelper.createStoneStair(woodDarkOak, 1, tab_decor);
	}
}
